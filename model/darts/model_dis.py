...
class Cell(nn.Module):
  ...
  def __init__(self, genotype, C_prev_prev, C_prev, C, reduction, reduction_prev, drop_prob=0.2):
    ...
    self.disout = LinearScheduler(Disout(drop_prob, block_size=6, alpha=5), start_value=0.,
                                  stop_value=drop_prob, nr_steps=5e3)
